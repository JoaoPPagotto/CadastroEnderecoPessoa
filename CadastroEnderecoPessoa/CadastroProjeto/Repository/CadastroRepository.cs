...
namespace CadastroEnderecoPessoa.CadastroProjeto.Repository
{
    public class CadastroRepository
    {
        private readonly CadastroDb _dbContext;

        public CadastroRepository(CadastroDb dbContext)
        {
        ...
        {
            return _dbContext.Endereco.Where(endereco => endereco.IdPessoa == id).ToList();
        }
